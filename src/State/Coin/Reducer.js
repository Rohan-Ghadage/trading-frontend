...
import { FETCH_COIN_LIST_REQUEST, FETCH_COIN_BY_ID_REQUEST, 
    FETCH_COIN_DETAILS_REQUEST, SEARCH_COIN_REQUEST, 
    FETCH_TOP_50_COINS_REQUEST, FETCH_MARKET_CHART_REQUEST, 
    FETCH_COIN_LIST_SUCCESS, FETCH_TOP_50_COINS_SUCCESS,
     FETCH_MARKET_CHART_SUCCESS, FETCH_COIN_BY_ID_SUCCESS, 
     SEARCH_COIN_SUCCESS, FETCH_COIN_DETAILS_SUCCESS, 
     FETCH_MARKET_CHART_FAILURE, FETCH_COIN_LIST_FAILURE,
     SEARCH_COIN_FAILURE, FETCH_COIN_BY_ID_FAILURE, 
