...
import { DollarSign, UploadIcon, WalletIcon } from "lucide-react"
      ...
      <Card>
        <CardHeader className="pb-9">
          <div className="flex justify-between items-center">
              ...
              <div>
                {/* when reload icon is clicked walllet balance gets refreshed */}
        ...
        <div className="space-y-5 ">
          ...
          (<div key={i}>
            ...
            items-center p-2">
              ...
              <div className="flex items-center gap-5">
                {/* when user clicks refresh button wallet transaction will be fetched */}
