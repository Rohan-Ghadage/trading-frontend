...
const Profile = () => {
  // function to fetch data from auth into Profile
            ...
            <div className='lg:flex gap-32'>
              <div className='space-y-7'>
                <div className='flex'>
                  ...
                  {/* if user is not null then do this */}
                  <p className='text-gray-500'>{auth.user?.email}</p>
                </div>
                <div className='flex'>
                  <p className='w-[9rem]'>Full Name : </p>
                  {/* full name will be fetched from user registration */}
                  <p className='text-gray-500'>{auth.user?.fullName}</p>
                </div>
                <div className='flex'>
                  <p className='w-[9rem]'>Date of Birth : </p>
                  <p className='text-gray-500'>18/09/2003</p>
                </div>
                <div className='flex'>
              ...
              <div className='space-y-7'>
                ...
                <div className='flex'>
                  <p className='w-[9rem]'>Full Name : </p>
                  <p className='text-gray-500'>Rohan Ghadage</p>
                </div>
                <div className='flex'>
                  <p className='w-[9rem]'>Date of Birth : </p>
                  <p className='text-gray-500'>18/09/2003</p>
