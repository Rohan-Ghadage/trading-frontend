...
//  when chatBot is clicked then only it will be opened
...
{isBotRealease &&  <div className='rounded-md w-[20rem] md:w-[25rem] 
                lg:w-[25rem] h-[70vh] bg-slate-900'>
                    ...
                    py-2 scroll-container'>
                       ...
                       <div className='justify-end self-end px-5 py-2 rounded-md
                        bg-slate-800 w-auto'>
                            <p>Hi, Ram Arora</p>
                            <p>you can ask crypto related queries to me</p>
